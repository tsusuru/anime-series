    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('series.store') }}" class="space-y-5">
                    @csrf
                    ...
                    <div>
                        ...
                        <textarea name="synopsis" class="w-full border rounded px-3 py-2" required>{{ old('synopsis') }}</textarea>
                    ...
                    <div class="grid sm:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="number" name="episodes" min="1" value="{{ old('episodes') }}" class="w-full border rounded px-3 py-2" required>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input type="date" name="release_date" value="{{ old('release_date') }}" class="w-full border rounded px-3 py-2" required>
                    ...
                    <div>
                        ...
                        <select name="publisher_id" class="w-full border rounded px-3 py-2" required>
                            <option value="">-- Kies publisher --</option>
                    ...
                    <div class="flex gap-3">
                        <button class="px-4 py-2 bg-gray-900 text-white rounded">Opslaan</button>
                        <a href="{{ route('series.index') }}" class="underline">Annuleren</a>
                    </div>
                </form>
